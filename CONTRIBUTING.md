...
***Ask not what IntelliTask can do for you - ask what you can do for IntelliTask***
...
2. Include additional information such as:
    ...
    * IntelliTask Debug-Info containing:
...
1. Respect existing IntelliTask coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
